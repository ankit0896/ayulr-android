...
public class ParaViewProfessionalActivity extends Fragment {
    TextView etcategory, etdegree,etexperience,etwork,etnature,etexpert,etalsotreat,ethomevisitfee,etvalid,ethomevisit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_para_view_professional, container, false);
