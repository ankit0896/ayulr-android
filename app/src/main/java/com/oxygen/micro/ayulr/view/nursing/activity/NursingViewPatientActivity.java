...
public class NursingViewPatientActivity extends AppCompatActivity {
    ...
    String HttpURL1 = "https://ameygraphics.com/ayulr/ayulr_api/filter_patient2.php";
    String HttpU = "https://ameygraphics.com/ayulr/ayulr_api/cancel_booking.php";
    String ParseResult;
    ...
    String HttpURL = "https://ameygraphics.com/ayulr/ayulr_api/update_booking.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(NursingViewPatientActivity.this, mTimeSetListener, mHour, mMinute, false).show();

            }
        });
        if (NetworkDetactor.isNetworkAvailable(NursingViewPatientActivity.this)) {
            HttpWebCall(IdHolder);
        } else {
            Toast.makeText(NursingViewPatientActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
        }
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem) {
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(NursingViewPatientActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(NursingViewPatientActivity.this).execute();
    ...
    public void UpdateDoctorRegistration(String date, String time,String id) {
        ...
        class UpdateDoctorRegistrationClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(NursingViewPatientActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("success")) {
                    Toast.makeText(NursingViewPatientActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(NursingViewPatientActivity.this, NursingDashboard.class);
