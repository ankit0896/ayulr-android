...
public class PasswordActivity extends AppCompatActivity {
    ...
    String HttpURL1 = Config.BASEURL+"change_password.php";
    String finalResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnchange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                GetDataFromEditText();
                if (NetworkDetactor.isNetworkAvailable(PasswordActivity.this)) {
                if (CheckEditText) {
                    ...
                    Toast.makeText(PasswordActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void RecordUpdate(final String userid, final String password, final String newpassword){
        ...
        class RecordUpdateClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(PasswordActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("Update Sucessfully")) {
                    Toast.makeText(PasswordActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
