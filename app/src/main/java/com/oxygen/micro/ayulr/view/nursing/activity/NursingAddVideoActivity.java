...
public class NursingAddVideoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nuring_add_video);
        initViews();
    }
    ...
    public void onClick(View view) {
        if(view==button){
            GetDataFromEditText();
            if (CheckEditText) {
                if (NetworkDetactor.isNetworkAvailable(NursingAddVideoActivity.this)) {
                    RecordUpdate(username, userdisg, userlink, ImageHolder, userid);
                } else {
                    Toast.makeText(NursingAddVideoActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
                }
    ...
    public void RecordUpdate(final String username, final String userdesig, final String userlink, final String userimage, final String userid) {
        ...
        class RecordUpdateClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(NursingAddVideoActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("your video successfully added")) {
                    Toast.makeText(NursingAddVideoActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
