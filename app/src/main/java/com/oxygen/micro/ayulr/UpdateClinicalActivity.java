...
public class UpdateClinicalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User user = SharedPrefManager.getInstance(UpdateClinicalActivity.this).getUser();
        IdHolder = String.valueOf(user.getId());
        Log.e("value=", " " + IdHolder);
        if (NetworkDetactor.isNetworkAvailable(UpdateClinicalActivity.this)) {
            HttpWebCall(String.valueOf(IdHolder));
        } else {
            Toast.makeText(UpdateClinicalActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
        }
        ...
        etvisitday.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder MBuilder = new AlertDialog.Builder(UpdateClinicalActivity.this);
        ...
        etmrngtime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener, mrngtimeHour, mrngtimeMinute, false).show();
            }
        });
        etmrngtimeto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID1);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener1, mrngtoHour, mrngtoMinute, false).show();
            }
        });
            ...
            public void onClick(View v) {
              ...
              //  DialogFragment newFragment = new TimePickerFragment2();
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID2);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener2, evngtimeHour, evngtimeMinute, false).show();
            }
        });
        etevngto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener3, evngtoHour, evngtoMinute, false).show();
            }
        });
        etaftertime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID4);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener4, aftertimeHour, aftertimeMinute, false).show();
            }
        });
        ...
        etothermrngtime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID6);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener6, othermrngtimeHour, othermrngtimeMinute, false).show();
            }
        });
        etothermrngto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID7);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener7, othermrngtoHour, othermrngtoMinute, false).show();
            }
        });
        etotherevngtime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID8);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener8, otherevngtimeHour, otherevngtimeMinute, false).show();
            }
        });
            ...
            public void onClick(View v) {
              ...
              //  DialogFragment newFragment = new TimePickerFragment9();
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID9);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener9, otherevngtoHour, otherevngtoMinute, false).show();
            }
        });
        etotheraftertime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID10);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener10,otheraftertimeHour ,otheraftertimeMinute, false).show();
            }
        });
        etotherafterto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // newFragment.show(getSupportFragmentManager(), TIME_DIALOG_ID11);
                new TimePickerDialog(UpdateClinicalActivity.this, mTimeSetListener11, otheraftertoHour, otheraftertoMinute, false).show();
            }
        });
    ...
    public void UpdateDoctorRegistration(String cl_name, String fees,String valid_day, String day,String m_from1,String m_to1,String a_from1,
        ...
        class UpdateDoctorRegistrationClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(UpdateClinicalActivity.this, "Loading Data", null, true, true);
            }
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
              ...
              //  progressDialog.dismiss();
                ...
                s = httpResponseMsg;
                new GetHttpResponse(UpdateClinicalActivity.this).execute();
