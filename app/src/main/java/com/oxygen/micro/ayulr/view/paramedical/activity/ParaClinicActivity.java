...
import com.oxygen.micro.ayulr.view.paramedical.adapter.ParaClinicalCityAdapter;
...
public class ParaClinicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String HttpURL = "https://ameygraphics.com/ayulr/api/paramedical/clinical.php";
    ...
    String se;
    ParaClinicalCityAdapter cityAdapter;
    String CodeHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_para_clinic);
        init();
    }
    ...
    private void init() {
        ...
        cityAdapter = new ParaClinicalCityAdapter(this);
        StateAdapter stateAdapter = new StateAdapter(ParaClinicActivity.this, State, Code);
    ...
    public void onClick(View v) {
        if (v == etmrngtime) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener, mrngtimeHour, mrngtimeMinute, false).show();
        }
        if (v == drimageView) {
            switch (v.getId()) {
                case R.id.drimage:
        ...
        if (v == etvisitday) {
            AlertDialog.Builder MBuilder = new AlertDialog.Builder(ParaClinicActivity.this);
        ...
        if (v == etmrngtimeto) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener1, mrngtoHour, mrngtoMinute, false).show();
        }
        if (v == etevngtime) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener2, evngtimeHour, evngtimeMinute, false).show();
        }
        if (v == etevngto) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener3, evngtoHour, evngtoMinute, false).show();
        }
        if (v == etaftertime) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener4, aftertimeHour, aftertimeMinute, false).show();
        }
        if (v == etafterto) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener5, aftertoHour, aftertoMinute, false).show();
        }
        if (v == etothermrngtime) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener6, othermrngtimeHour, othermrngtimeMinute, false).show();
        }
        if (v == buttonclinic) {
            CheckEditTextIsEmptyOrNot();
            if (NetworkDetactor.isNetworkAvailable(ParaClinicActivity.this)) {
                if (CheckEditText) {
                    if (!(StateHolder.equals("Select State"))) {
                        ...
                        Toast.makeText(ParaClinicActivity.this, "Select State", Toast.LENGTH_SHORT).show();
                    }
                } else {

                }
            } else {
                Toast.makeText(ParaClinicActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
            }
        }
        if (v == etothermrngto) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener7, othermrngtoHour, othermrngtoMinute, false).show();
        }

        if (v == etotherafterto) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener11, otheraftertoHour, otheraftertoMinute, false).show();
        }
        if (v == etotheraftertime) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener10, otheraftertimeHour, otheraftertimeMinute, false).show();

        }
        if (v == etotherevngtime) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener8, otherevngtimeHour, otherevngtimeMinute, false).show();
        }
        if (v == etotherevngto) {
            new TimePickerDialog(ParaClinicActivity.this, mTimeSetListener9, otherevngtoHour, otherevngtoMinute, false).show();
        }
 ...
 /*   public static class TimePickerFragment11 extends DialogFragment
    ...
    public void DoctorRegistration(String cl_name, String fees, String valid_day, String day, String m_from1, String m_to1, String a_from1,
        ...
        class DoctorRegistrationClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(ParaClinicActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                JSONObject obj = null;
                try {
                    obj = new JSONObject(httpResponseMsg);
                    if (obj.getString("message").equals("Sucess")) {
                        progressDialog.dismiss();
                        Toast.makeText(ParaClinicActivity.this, "You are registered Successfully\nPlease login to access your account", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(ParaClinicActivity.this, ActivityLoginpara.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();
                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(ParaClinicActivity.this, httpResponseMsg, Toast.LENGTH_LONG).show();
                    }
    ...
    class MyAsync extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ParaClinicActivity.this, "Processing", "please wait moment...");
        }
