...
public class ParaUpdateProfessionalActivity extends AppCompatActivity {
    String HttpURL1 = Config.BASEURL+"filter_view.php";
    String ParseResult;
    HashMap<String, String> ResultHash = new HashMap<>();
    String s;
    EditText etdegree,etexperience,etworkin,etnature,etexpertise,etalsotreat,ethomevisitfee,etvalidfor,etcategory;
