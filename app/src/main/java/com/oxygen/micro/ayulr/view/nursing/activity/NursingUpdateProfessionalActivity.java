...
public class NursingUpdateProfessionalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String HttpURL = Config.BASEURL + "nursing/update_professional.php";
    String[] listitem2;
