...
public class NursingNewPostActivity extends AppCompatActivity {
    ...
    String HttpURL = "https://ameygraphics.com/ayulr/ayulr_api/insert_blog.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonpost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (NetworkDetactor.isNetworkAvailable(NursingNewPostActivity.this)) {
                    NewPost(String.valueOf(userId),UserName,ImageHolder,Description);
                } else {
                    Toast.makeText(NursingNewPostActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
                }
    ...
    public void NewPost(String id,String username,String image,String desc) {
        ...
        class NewPostClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(NursingNewPostActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("success")) {
                    Toast.makeText(NursingNewPostActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
                    Intent newPostIntent = new Intent(NursingNewPostActivity.this, NursingForumActivity.class);
