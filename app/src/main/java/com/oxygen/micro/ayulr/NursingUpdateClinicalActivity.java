...
public class NursingUpdateClinicalActivity extends AppCompatActivity {
    EditText etfee,etfeevalid,etvisitday,etcontact,
            etstate,etcity,etpincode,etaddress;
    ...
    String HttpURL = "https://ameygraphics.com/ayulr/ayulr_api/nursing/update_clinical.php";
