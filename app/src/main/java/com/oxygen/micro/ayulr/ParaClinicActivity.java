...
public class ParaClinicActivity extends AppCompatActivity {
    ...
    String HttpURL = "https://ameygraphics.com/ayulr/ayulr_api/paramedical/clinical.php";
        ...
        class DoctorRegistrationClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("success")) {
                    // Toast.makeText(ParaClinicActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
                    ...
                    finish();
                   // Intent intent = new Intent(ParaClinicActivity.this, ParaPlanActivity.class);
