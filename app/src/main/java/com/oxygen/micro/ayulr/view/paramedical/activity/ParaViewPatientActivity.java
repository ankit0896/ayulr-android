...
public class ParaViewPatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(ParaViewPatientActivity.this, mTimeSetListener, mHour, mMinute, false).show();

            }
        });
        if (NetworkDetactor.isNetworkAvailable(ParaViewPatientActivity.this)) {
            HttpWebCall(IdHolder);
        } else {
            Toast.makeText(ParaViewPatientActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
        }
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem) {
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(ParaViewPatientActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(ParaViewPatientActivity.this).execute();
    ...
    public void UpdateDoctorRegistration(String date, String time,String id) {
        ...
        class UpdateDoctorRegistrationClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(ParaViewPatientActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("success")) {
                    Toast.makeText(ParaViewPatientActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(ParaViewPatientActivity.this, ParaDashboard.class);
