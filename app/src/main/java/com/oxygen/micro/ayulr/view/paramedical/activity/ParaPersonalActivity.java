...
import com.oxygen.micro.ayulr.view.paramedical.adapter.ParaCityAdapter;
...
public class ParaPersonalActivity extends AppCompatActivity {
    ...
    String HttpURL = Config.BASEURL+"paramedical/personal.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_para_personal);
        ...
        StateAdapter stateAdapter = new StateAdapter(ParaPersonalActivity.this, State,Code);
        ...
        buttonpersonal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (NetworkDetactor.isNetworkAvailable(ParaPersonalActivity.this)) {
                    if (CheckEditText) {
                        if (!(StateHolder.equals("Select State"))) {
                            ...
                            Toast.makeText(ParaPersonalActivity.this, "Select State", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Toast.makeText(ParaPersonalActivity.this, "No Internet Available", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void DoctorRegistration(String doctor_n, String dob,String gender, String email,String cont, String doa,String member_of,
        ...
        class DoctorRegistrationClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(ParaPersonalActivity.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if (httpResponseMsg.equals("success")) {
                    ...
                    Intent intent = new Intent(ParaPersonalActivity.this, ParaProfessionalActivity.class);
                    intent.putExtra("email", EmailHolder);
                    startActivity(intent);
                    finish();
                }else{
                    Toast.makeText(ParaPersonalActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
                }
            }
    ...
    class MyAsync extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ParaPersonalActivity.this, "Processing", "please wait moment...");
        }
